...
def get_joints(g, s, t):
    ...
    lfoot = g[s, t, 15, :] - root
    root = root - root
    return root, spine, neck, head, rshoulder, relbow, rhand, lshoulder, lelbow, lhand, rhip, rknee, rfoot, lhip, lknee, lfoot
...
def get_affective_features(gaits):
    ...
    for sidx in range(num_samples):
        ...
        for tidx in range(num_tsteps):
            ...
            fidx += 48
            # within frame
            _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15 = get_joints(
                gaits, sidx, tidx)
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_7, _2, _4)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_2, _4, _7)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_4, _7, _2)
            fidx += 1
            affective_features[sidx, tidx, fidx] = angle_between_vectors(
                _3-_0, up_vector)
            fidx += 1
            ...
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_2, _4, _5)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_2, _7, _8)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_4, _5, _6)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_7, _8, _9)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_2, _1, _0)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_3, _2, _1)
            fidx += 1
            ...
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = area_of_triangle(_15, _2, _12)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = area_of_triangle(_13, _2, _10)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = area_of_triangle(_15, _0, _12)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = area_of_triangle(_14, _2, _11)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_0, _10, _11)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_0, _13, _14)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_10, _11, _12)
            fidx += 1
            affective_features[sidx, tidx,
                               fidx] = angle_between_points(_13, _14, _15)
            fidx += 1
            ...
            # between frames
            if tidx > 0:
                _0_1, _1_1, _2_1, _3_1, _4_1, _5_1, _6_1, _7_1, _8_1, _9_1, _10_1, _11_1, _12_1, _13_1, _14_1, _15_1 = get_joints(
                    gaits, sidx, tidx-1)
                affective_features[sidx, tidx, fidx:fidx+8] = get_dynamics(_6, _6_1, affective_features[sidx, tidx - 1, fidx:fidx+3],
                                                                           affective_features[sidx, tidx-1, fidx+4:fidx+7])
                fidx += 8
                affective_features[sidx, tidx, fidx:fidx+8] = get_dynamics(_9, _9_1, affective_features[sidx, tidx - 1, fidx:fidx+3],
                                                                           affective_features[sidx, tidx-1, fidx+4:fidx+7])
                fidx += 8
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _5, _5_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _8, _8_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _4, _4_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _7, _7_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+8] = get_dynamics(_12, _12_1, affective_features[sidx, tidx - 1, fidx:fidx+3],
                                                                           affective_features[sidx, tidx - 1, fidx+4:fidx+7])
                fidx += 8
                affective_features[sidx, tidx, fidx:fidx+8] = get_dynamics(_15, _15_1, affective_features[sidx, tidx - 1, fidx:fidx+3],
                                                                           affective_features[sidx, tidx - 1, fidx+4:fidx+7])
                fidx += 8
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _11, _11_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _14, _14_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _10, _10_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+7] = get_dynamics(
                    _13, _13_1, affective_features[sidx, tidx - 1, fidx:fidx+3])
                fidx += 7
                affective_features[sidx, tidx, fidx:fidx+8] = get_dynamics(_3, _3_1, affective_features[sidx, tidx - 1, fidx:fidx+3],
                                                                           affective_features[sidx, tidx - 1, fidx+4:fidx+7])
                fidx += 8
